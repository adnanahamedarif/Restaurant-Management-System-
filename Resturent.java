...
public class Resturent extends JFrame implements MouseListener, ActionListener {
    ...
    public Resturent() {
        ...
        super.setBounds(500, 200, 1300, 800);
        ...
        //item 5
        i1 = new ImageIcon("ChickenFry.png");
        l7 = new JLabel(i1);
        ...
        //item 6
        i1 = new ImageIcon("FruitsSalad.png");
        l7 = new JLabel(i1);
        ...
        //item 7
        i1 = new ImageIcon("FrenchFries.png");
        l7 = new JLabel(i1);
        ...
        //item 10
        i1 = new ImageIcon("ChickenBiryany.png");
        l7 = new JLabel(i1);
        ...
        //item 11
        i1 = new ImageIcon("FriedRice.png");
        l7 = new JLabel(i1);
        ...
        //item 12
        i1 = new ImageIcon("ColdDrinks.png");
        l7 = new JLabel(i1);
    ...
    public void actionPerformed(ActionEvent ae) {
		...
		{
			try {
				BufferedWriter writer = new BufferedWriter (new FileWriter ("order_history.txt",true));
