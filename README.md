...
Uses event-driven programming (ActionListener, MouseListener)

File I/O operations for order history

DateTime formatting for receipts

Image icons for menu items

How It Works
Add food items to cart with quantities

Apply discounts as needed

Confirm orders and view billing

Track order history in the sidebar
